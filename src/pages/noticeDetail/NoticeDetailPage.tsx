...
export default function NoticeDetailPage() {
  ...
  const notices = [
    ...
    {
      id: "4",
      title: "럭키데이 웹사이트를 스마트폰 홈 화면에서 만나보세요.",
      date: "2024년 11월 30일",
      content: (
        <>
          안녕하세요! 새로운 소식을 가지고 온 팀 럭키데이 입니다. <br />
          <br /> <br />
          그동안 많은 분들이 앱 출시를 요청해주셨는데요, <br />
          이제 럭키데이를 모바일 홈 화면에 추가하면, <br />
          앱처럼 간편하게 사용할 수 있어요! 👏 <br />
          <br />
          <br />
          📱 럭키데이 웹 앱(PWA) 설치 방법 <br />
          <ol>
            <li>
              스마트폰에서 Chrome 또는 Safari를 통해 럭키데이 웹사이트에
              접속합니다.
            </li>
            <li>
              Chrome 또는 Safari의 상단 혹은 하단에 있는 더보기 메뉴 아이콘을
              클릭합니다.
            </li>
            <li>메뉴 중 [홈 화면에 추가]를 클릭하여 웹 앱을 설치합니다.</li>
          </ol>
          <br />
          <br />
          이제 스마트폰 홈 화면에 추가된 아이콘을 통해 <br />
          더 빠르고 간편하게 럭키데이를 즐겨보세요! <br />
          <br /> <br />
          따뜻하고 럭키한 연말 되시길 바랍니다. 감사합니다. ❄️ <br />
        </>
      ),
    },
  ];
